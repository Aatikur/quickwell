...
<html lang="en" >
    ...
    <body>
        ...
        <div class="container">
            <div class="panel panel-default mb-5" style="margin-top: 20px">
                <div class="panel-heading" style="padding: 10px 20px 0">
                    <div class="row">
                        <div class="col-md-5 pull-left" style="width:41.66666667%">
                        ...
                        <div class="col-md-5 pull-right" style="display:grid;width:41.66666667%">
                            <h2 style="margin: 0;text-align:right;text-transform: uppercase;font-weight: 900;color: #1c6fb1;">Invoice</h2>
                            <strong style="text-align:right">Quickwell Remedy Healthcare Pvt Ltd </strong>
                            <small style="text-align:right">GSTIN 10AAACQ6817G1ZS</small>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <div class="col-md-6 mb-3 text-right" style="width: 50%;float:left">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                Client:
                            </div>
